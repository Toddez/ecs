class Matrix4 {
	...
	static multiplyVector(m, v) {
		return new Vector3(
			m[0 + 0 * 4].x * v.x + m[1 + 0 * 4].x * v.y + m[2 + 0 * 4].x * v.z + m[3 + 0 * 4].x,
			m[0 + 1 * 4].y * v.x + m[1 + 1 * 4].y * v.y + m[2 + 1 * 4].y * v.z + m[3 + 1 * 4].y,
			m[0 + 2 * 4].z * v.x + m[1 + 2 * 4].z * v.y + m[2 + 2 * 4].z * v.z + m[3 + 2 * 4].z
		);
	}
